...
# train a model with one input layer, 1 hidden layer and 1 output layer
...
# Addestra la rete
epochs = 750  # Puoi aumentare il numero di epoche per un'accuratezza migliore
...
save_model([dense1, dense2, dense3], 'model_750_epochs.json', path=path)
