...
# Addestra la rete
epochs = 400 # Puoi aumentare il numero di epoche per un'accuratezza migliore
for epoch in range(epochs):
    ...
    loss = loss_activation.forward(dense6.output, y_train)
    ...
    optimizer.update_parameters(dense6)
    optimizer.post_update_params()

path = "./"

# Salva i pesi del modello
save_model([dense1, dense2, dense3, dense4, dense5, dense6], 'model_4_400_epochs.json', path=path)
