...
models_path = [
    'model_2_600_epochs.json',
    'model_3_450_epochs.json',
    'model_3_600_epochs.json',
    'model_500_epochs.json',
    'model_600_epochs.json', 
    'model_750_epochs.json',
    'model_1000_epochs.json'
]
...
load_model([dense1, dense2, dense3, dense4, dense5], models_path[1])
...
loss = loss_activation.forward(dense5.output, y_test)
